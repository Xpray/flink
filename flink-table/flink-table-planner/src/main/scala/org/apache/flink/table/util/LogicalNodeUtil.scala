...
import org.apache.flink.table.plan.logical.{Aggregate, AliasNode, BinaryNode, CatalogNode, Distinct, Filter, Intersect, Join, Limit, LogicalNode, LogicalRelNode, LogicalTableFunctionCall, Minus, Project, Sort, UnaryNode, Union, WindowAggregate}
    ...
    node match {
      ...
      case u: UnaryNode =>
        ...
        u match {
          ...
          case Project(projectList, _, alias) => Project(projectList, child, alias)
