...
public abstract class ExecutionEnvironment {
	 ...
	 * ResultPartitionDescriptors generated by all Jobs executed via this Environment.
	 * Only BLOCKING_PERSISTENT ResultPartitions are kept for now.
	 */
	private final Map<AbstractID, Map<AbstractID, ResultPartitionDescriptor>> resultPartitionDescriptors = new HashMap<>();
	...
	public JobExecutionResult execute() throws Exception {
		...
		this.resultPartitionDescriptors.putAll(result.getResultPartitionDescriptors());
		return result;
	}
